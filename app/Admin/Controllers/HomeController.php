    ...
    public function index()
    {
        return Admin::content(function (Content $content) {
            ...
            $content->row(function ($row) {
                $row->column(3, new InfoBox('Users', 'users', 'aqua', '/admin/auth/users', Administrator::all('id')->count()));
                ...
                $row->column(3, new InfoBox('Events', 'calendar-o', 'red', '/admin/events', Event::all('id')->count()));
            });
